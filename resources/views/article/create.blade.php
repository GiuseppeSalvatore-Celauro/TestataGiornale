    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-8 border border-2 p-5">
                <p class="text-center font-primary mb-5 display-1">Inserisci il tuo articolo</p>
                <hr>
                <form action="{{ route('article.store') }}" class="px-5 d-flex flex-column gap-5" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex justify-content-around  mb-3 mt-5">
                        <input type="text" placeholder="titolo dell'articolo" class="form-login-custom w-50 me-5"
                            name="title">
                        <input type="text" placeholder="sottotitolo dell'articolo"
                    ...
                    <div class="d-flex flex-column justify-content-around gap-3">
                        ...
                        <select class="form-login-custom" name="category">
                            <option value="0">Scegli la tua categoria</option>
